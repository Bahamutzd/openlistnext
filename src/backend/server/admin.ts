    ...
    additional: [
      {
        ...
        default: "",
        required: false,
        help: "access_token（accessToken 登录模式，优先于账号密码）",
      },
      {
        name: "username",
        type: "string",
        default: "",
        required: false,
        help: "手机号 / 账号（access_token 缺失时用账号密码登录）",
      },
      {
        name: "password",
        type: "string",
    ...
    additional: [
      {
        ...
        default: "",
        required: true,
        help: "路径映射，每行一个。格式（与原版 OpenList 一致）：`虚拟根名:目标存储挂载路径`（如 电影:/115网盘/115影视），或裸路径 `/115网盘/115影视`（自动取最后一段作根名）",
      },
      {
        name: "siteUrl",
        type: "text",
        default: "",
        required: false,
        help: "strm 文件内容的前缀 URL（默认用本站 /api 地址）",
      },
      {
        name: "pathPrefix",
        type: "text",
      ...
      },
      {
        ...
        required: false,
        help: "支持转成 .strm 的媒体后缀（默认媒体扩展名列表）",
      },
      {
        ...
        required: false,
        help: "需要跟随下载的文件后缀（默认 ass,srt,vtt,sub,strm，字幕等小文件原样暴露）",
      },
      {
        name: "minFileSize",
        type: "number",
      ...
      },
      {
        ...
        default: "false",
        required: false,
        help: "是否在 strm 链接后附加 sign（本项目 sign_all 默认关，暂只附加占位）",
      },
    ],
    config: {
      name: "Strm",
